...
import { 
  ...
  ShoppingCart, ShieldAlert, FileText, ClipboardList, Database, UserPlus, X, RefreshCw, CreditCard 
} from 'lucide-react';
    ...
    <div className="flex h-screen bg-[#F8FAFC] overflow-hidden font-sans">
      ...
      <aside className="w-64 shrink-0 bg-white border-r border-gray-200 flex flex-col h-full overflow-hidden">
        <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100 shrink-0">
          <div className="w-9 h-9 rounded-full border border-gray-200 flex items-center justify-center overflow-hidden shrink-0 bg-white">
        ...
        <div className="border-t border-gray-100 p-4 shrink-0 flex flex-col gap-3">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs font-semibold text-gray-900 truncate">{session.username}</p>
              <p className="text-[10px] text-gray-400 font-medium">Licensed Pharmacist</p>
            </div>
          </div>
          <button 
            onClick={onLogout}
